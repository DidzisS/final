...
<body>
 ...
 <div class="container w-80">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <a class="navbar-brand" href="#">Mans nobeiguma darbs!</a>
...
<div class="forms">
    <form>
        ...
        <input type="text" name="zina" placeholder="Jūsu komentārs">
...
<!--Fūteris-->
<div class="py-4 bg-dark"> Lapas autors esmu es! 2018. gads. </div>
